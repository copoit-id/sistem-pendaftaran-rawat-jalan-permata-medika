            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ url('/admin/dashboard') }}"
                        class="flex items-center p-3 {{ $title == 'Dashboard' ? 'text-white' : 'text-white hover:bg-gray-100' }} rounded-lg  group">
                        <svg class="flex-shrink-0 w-5 h-5 {{ $title == 'Dashboard' ? ' text-red' : 'text-gray-500  group-hover:text-gray-900' }} transition duration-75 "
                ...
                <li>
                    <a href="{{ url('/admin/manajemen-bahan') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Pendaftaran Pasien</span>
                ...
                <li>
                    <a href="{{ url('/admin/manajemen-menu') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Keluhan Pasien</span>
                ...
                <li>
                    <a href="{{ url('/admin/manajemen-konten') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Manajemen Dokter</span>
                ...
                <li>
                    <a href="{{ url('/admin/karyawan') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Manajemen Petugas</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('/admin/karyawan') }}"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Laporan Rekam Medis</span>
                    </a>
                </li>
                <li class="sign-in">
                    <a href="#"
